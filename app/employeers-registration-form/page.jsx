...
export function generateMetadata() {
    return {
        title: 'Employeers Registration Form',
        ...
        alternates: { canonical: '/employeers-registration-form', },
    }
};

const EmployeersRegistrationForm = () => {
        ...
        <div className="md:h-[70vh] h-full flex items-center justify-center">
            <div className="py-20">
                <div className="flex md:flex-row flex-col-reverse items-center justify-center gap-20">
                    ...
                    <RegistrationForm role={"employeer"} />
                </div>
            </div>
        </div>
    );
...
export default EmployeersRegistrationForm;